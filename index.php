...
<body
    class="bg-background text-on-background antialiased selection:bg-primary-container selection:text-on-primary-container font-body-md text-body-md">
    ...
    <header
        ...
        <div
            ...
            <nav class="hidden md:flex items-center gap-sm">
                ...
                <a class="font-label-md text-label-md px-4 py-2 text-on-surface-variant font-medium hover:text-primary hover:bg-primary-container/20 rounded-lg transition-all duration-300 ease-in-out"
                    href="pages/treatment/treatment.php">Services</a>
                <a class="font-label-md text-label-md px-4 py-2 text-on-surface-variant font-medium hover:text-primary hover:bg-primary-container/20 rounded-lg transition-all duration-300 ease-in-out"
                    href="pages/spesialis.php">Doctors</a>
                <a class="font-label-md text-label-md px-4 py-2 text-on-surface-variant font-medium hover:text-primary hover:bg-primary-container/20 rounded-lg transition-all duration-300 ease-in-out"
                    href="pages/kontak.php">Contact</a>
            </nav>
            <!-- Actions -->
    ...
    <main class="pt-24 md:pt-32 pb-xl space-y-xl md:space-y-[120px]">
        ...
        <section class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop" id="home">
            <div
                class="relative rounded-2xl overflow-hidden min-h-[819px] md:min-h-[600px] flex items-center shadow-ambient bg-surface-container-lowest">
                <!-- Background Imagery -->
                <div class="absolute inset-0 z-0">
                    <img alt="Luxurious clinic interior" class="w-full h-full object-cover object-[70%_50%]"
                        data-alt="A bright, minimalist, high-end dermatology clinic interior. The space is bathed in natural, soft light coming from large windows. The decor features clean lines, warm white walls, subtle rose-gold metallic accents, and elegant beige stone flooring. A plush, cream-colored treatment chair is visible in the background alongside delicate dried floral arrangements, conveying a sense of luxury, serene tranquility, and rigorous clinical excellence."
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuCfpoHeV63Iv1D1ZlhEEFmWj4n4zzoqCjKJvQU474pO3D-8f25a3AQezpMahHj0DZsfni_YYVbaL4qWdGAlkIJTbkEHAJ2HLZYyLYbjTpejNPsnCAcCoIbFHSM4LpEyTw7HzlvCj1uJusjJX8g5g7Uh694G8SEFhAb22HPdlLrp6RvYi5fkuzAflI5XAypKz-BmRua_8d-7JDhTJ7vcAN34DQP2K3LwOT50_jiHQm_AAJn7I8lDQlGitWj553LF0q5f84k3CnhKaJ4">
                    <!-- Soft gradient to ensure text readability -->
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-surface/95 via-surface/80 to-transparent md:w-2/3">
                    </div>
                </div>
                ...
                <div class="relative z-10 w-full md:w-1/2 p-lg md:p-xl ml-0 md:ml-gutter">
                    <span
                        class="inline-block px-3 py-1 mb-sm rounded-full bg-secondary-container text-on-secondary-container font-label-sm text-label-sm uppercase tracking-wider">Clinical
                        Aesthetics</span>
                    <h1 class="font-display-lg text-display-lg text-on-background mb-md">Pancarkan Pesona Kulit Sehat
                        Alami.</h1>
                    <p class="font-body-lg text-body-lg text-on-surface-variant mb-lg max-w-md">Klinik dermatologi
                        profesional dengan perawatan eksklusif untuk kulit impian Anda.</p>
                    <div class="flex flex-row items-center gap-md">
                        <!-- Primary Button (Rose Gold/Primary style) -->
                        <a href="<?= isset($_SESSION['user_id']) ? 'pages/user/dashboarduser.php?page=daftar-konsul' : 'pages/auth/Signin.php' ?>"
                            class="font-label-md text-label-md bg-primary text-on-primary px-8 py-3 hover:bg-on-primary-fixed-variant transition-colors shadow-sm flex items-center justify-center gap-xs rounded-full">
                            <span class="">Book Appointment</span>
                        </a>
                        <!-- Secondary Button (Teal/Secondary style) -->
                        <a href="pages/treatment/treatment.php"
                            class="font-label-md text-label-md border-2 border-secondary text-secondary px-8 py-3 hover:bg-secondary-container hover:text-on-secondary-container transition-colors flex items-center justify-center rounded-full">Explore
                            Services</a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
                ...
                <div class="md:col-span-6 md:col-start-7 order-1 md:order-2 space-y-md">
                    ...
                    <p class="font-body-lg text-body-lg text-on-surface-variant">
                        Visi kami adalah menjadikan setiap individu merasa percaya diri dengan kulit sehat yang natural.
                        Kami memadukan standar medis tertinggi dengan sentuhan perawatan personal.
                    </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-md pt-sm">
                        <!-- Advantage 1 -->
                        <div
                            class="flex flex-col items-start p-md bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/30 transition-ambient hover:shadow-ambient-hover">
                            <div
                                class="w-12 h-12 rounded-full bg-secondary-container flex items-center justify-center mb-4">
                                <span class="material-symbols-outlined text-secondary"
                                    style="font-size: 28px;">medical_services</span>
                            </div>
                            <div class="space-y-xs">
                                <h4 class="font-headline-md text-label-md text-on-background">Dokter Spesialis
                                    Berpengalaman</h4>
                                <p class="font-body-sm text-body-sm text-on-surface-variant">Ditangani langsung oleh
                                    ahlinya.</p>
                            </div>
                        </div>
                        <!-- Advantage 2 -->
                        <div
                            class="flex flex-col items-start p-md bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/30 transition-ambient hover:shadow-ambient-hover">
                            <div
                                class="w-12 h-12 rounded-full bg-primary-container/30 flex items-center justify-center mb-4">
                                <span class="material-symbols-outlined text-primary"
                                    style="font-size: 28px;">verified_user</span>
                            </div>
                            <div class="space-y-xs">
                                <h4 class="font-headline-md text-label-md text-on-background">Bahan &amp; Produk
                                    Bersertifikasi Aman</h4>
                                <p class="font-body-sm text-body-sm text-on-surface-variant">Standar BPOM dan klinis.
                                </p>
                            </div>
                        </div>
                        <!-- Advantage 3 -->
                        <div
                            ...
                            <div
                                class="w-12 h-12 rounded-full bg-primary-container/30 flex items-center justify-center mb-4">
                                <span class="material-symbols-outlined text-primary"
                                    style="font-size: 28px;">biotech</span>
                            </div>
                            <div class="space-y-xs">
                                <h4 class="font-headline-md text-label-md text-on-background">Teknologi Perawatan Modern
                                </h4>
                                <p class="font-body-sm text-body-sm text-on-surface-variant">Inovasi terkini untuk hasil
                                    optimal.</p>
                            </div>
                        </div>
                        <!-- Advantage 4 -->
                        <div
                            ...
                            <div
                                class="w-12 h-12 rounded-full bg-secondary-container flex items-center justify-center mb-4">
                                <span class="material-symbols-outlined text-secondary"
                                    style="font-size: 28px;">forum</span>
                            </div>
                            <div class="space-y-xs">
                                <h4 class="font-headline-md text-label-md text-on-background">Konsultasi Pasca-Tindakan
                                    Gratis</h4>
                                <p class="font-body-sm text-body-sm text-on-surface-variant">Layanan chat dukungan
                                    pasien.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-surface-container-low py-xl" id="services">
            <div class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop">
                <div class="text-center mb-lg">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-2xl mx-auto">Solusi komprehensif
                        untuk berbagai kebutuhan kulit Anda.</p>
                </div>
                <div class="space-y-xl md:space-y-[120px]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center group">
                        <div
                            class="md:col-span-7 relative overflow-hidden rounded-2xl shadow-ambient transition-ambient group-hover:shadow-ambient-hover">
                            <img alt="Acne Care Treatment"
                                class="w-full h-[400px] md:h-[500px] object-cover transition-transform duration-500 group-hover:scale-105"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAvrhAThQxDTgZrCDVovPmwdRJKolhluPDE91UUWSi2Oqe5DXfHZDGqvzC37MeK0nPrAUCXL8AsPAnaaLMf82DtVsq0z1LqRd8dfi8QkXxJXPyXi-W-Jf23o6mH65P430faGYNYfZ22YnMR6pbArgkgqaRXvomeMiuw3PjzfnHaGF56rQYy5PuU85j-jEEuoox5GaLYv5EAd9VQaL3QAUyJ5iRswc_Bpsz6ufFZksAVA5A1dsj43Kqu_Flh2bE7EfJpsyRwy3wdpb0">
                            <div
                        ...
                        <div class="md:col-span-5 md:pl-lg space-y-md">
                            <span
                                class="inline-block px-3 py-1 rounded-full bg-secondary-container text-on-secondary-container font-label-sm text-label-sm uppercase tracking-wider">Acne
                                &amp; Pores</span>
                            <h3 class="font-headline-lg text-display-lg text-on-background">Acne Care</h3>
                            <p class="font-body-lg text-body-lg text-on-surface-variant">Perawatan intensif untuk
                                mengatasi jerawat membandel dan komedo, menenangkan peradangan, dan mencegah bekas luka
                                dengan teknologi terkini.</p>
                            <a class="inline-flex items-center gap-sm font-label-md text-label-md text-primary hover:text-on-primary-fixed-variant transition-colors group/link"
                                href="pages/treatment/treatment.php?category=Acne">Detail Layanan <span
                                    class="material-symbols-outlined text-sm transition-transform group-hover/link:translate-x-1">arrow_forward</span></a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center group">
                        <div class="md:col-span-5 md:pr-lg order-2 md:order-1 space-y-md">
                            <span
                                class="inline-block px-3 py-1 rounded-full bg-primary-container/30 text-on-primary-container font-label-sm text-label-sm uppercase tracking-wider">Pigmentation</span>
                            <h3 class="font-headline-lg text-display-lg text-on-background">Brightening Therapy</h3>
                            <p class="font-body-lg text-body-lg text-on-surface-variant">Solusi efektif untuk
                                mencerahkan kulit kusam, memudarkan flek hitam, dan meratakan warna kulit untuk kilau
                                alami yang sehat.</p>
                            <a class="inline-flex items-center gap-sm font-label-md text-label-md text-primary hover:text-on-primary-fixed-variant transition-colors group/link"
                                href="pages/treatment/treatment.php?category=Brightening">Detail Layanan <span
                                    class="material-symbols-outlined text-sm transition-transform group-hover/link:translate-x-1">arrow_forward</span></a>
                        </div>
                        <div
                            class="md:col-span-7 order-1 md:order-2 relative overflow-hidden rounded-2xl shadow-ambient transition-ambient group-hover:shadow-ambient-hover">
                            <img alt="Brightening Therapy"
                                class="w-full h-[400px] md:h-[500px] object-cover transition-transform duration-500 group-hover:scale-105"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAoqh0qnJ_ZtymedJ_mDDK4ofHRObnvt1AXIV5D6j9_JwwOjN1qRI2AwedAaOnnK91ZZ7q8GOeyf4sbgechDVBpIKF_G4sCXPTd_cHCGOnwdpBmta0ZTofnzX6Mk7PNM8jhzUkWz2FprCWO_kHHUvnbOGFTv1f_IMyL3IFRQzZqxyujQivTi47nUsMMsD3r_iP3O3otaX3NVkdskXaUldXM5lTIgxf0p-bNCpiQ8k3wORggrq47zVrtF_7E3b39OeCjwrxnVzurIjQ">
                            <div
                                class="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center group">
                        <div
                            class="md:col-span-7 relative overflow-hidden rounded-2xl shadow-ambient transition-ambient group-hover:shadow-ambient-hover">
                            <img alt="Anti-Aging Treatment"
                                class="w-full h-[400px] md:h-[500px] object-cover transition-transform duration-500 group-hover:scale-105"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBHIyaZtHgB9-8Ma1wRI2qdpQ_mlBW4TikgxWo1v7SyJH2mL2ITRUYHmKl0LLqJl2wCu4IntY92a6WhnHFqhBUGeoCTQ7RcOzho9RhuIgFpZ4eElJgMh8Wx-bL67tXt95vgfRxQL530ZJ8LsJTP6H2Qy6QnjVGyIlylVcY2V1Gq2sJlZ-qzmoAG8vSndsSQMGwLMn89aX9JGN5PmIEddRGB8_KZCnp-xniPpcWoYaue8yID0bsmTa2Zw3h3pZQso8YKNrm53JwGW54">
                            <div
                                class="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            </div>
                        </div>
                        <div class="md:col-span-5 md:pl-lg space-y-md">
                            <span
                                class="inline-block px-3 py-1 rounded-full bg-tertiary-container/50 text-on-tertiary-container font-label-sm text-label-sm uppercase tracking-wider">Rejuvenation</span>
                            <h3 class="font-headline-lg text-display-lg text-on-background">Anti-Aging</h3>
                            <p class="font-body-lg text-body-lg text-on-surface-variant">Terapi peremajaan kulit premium
                                untuk mengurangi garis halus, mengencangkan kerutan, dan mengembalikan elastisitas kulit
                                muda Anda.</p>
                            <a class="inline-flex items-center gap-sm font-label-md text-label-md text-primary hover:text-on-primary-fixed-variant transition-colors group/link"
                                href="pages/treatment/treatment.php?category=Anti-Aging">Detail Layanan <span
                                    class="material-symbols-outlined text-sm transition-transform group-hover/link:translate-x-1">arrow_forward</span></a>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center group">
                        <div class="md:col-span-5 md:pr-lg order-2 md:order-1 space-y-md">
                            <span
                                class="inline-block px-3 py-1 rounded-full bg-primary-container/30 text-on-primary-container font-label-sm text-label-sm uppercase tracking-wider">Body
                                &amp; Scalp</span>
                            <h3 class="font-headline-lg text-display-lg text-on-background">Hair &amp; Body Care</h3>
                            <p class="font-body-lg text-body-lg text-on-surface-variant">Perawatan menyeluruh untuk
                                kesehatan rambut dan keindahan tubuh, menggunakan teknik relaksasi premium dan produk
                                klinis terbaik.</p>
                            <a class="inline-flex items-center gap-sm font-label-md text-label-md text-primary hover:text-on-primary-fixed-variant transition-colors group/link"
                                href="pages/treatment/treatment.php?category=Body">Detail Layanan <span
                                    class="material-symbols-outlined text-sm transition-transform group-hover/link:translate-x-1">arrow_forward</span></a>
                        </div>
                        <div
                            class="md:col-span-7 order-1 md:order-2 relative overflow-hidden rounded-2xl shadow-ambient transition-ambient group-hover:shadow-ambient-hover">
                            <img alt="Hair &amp; Body Care Treatment"
                                class="w-full h-[400px] md:h-[500px] object-cover transition-transform duration-500 group-hover:scale-105"
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuADfMGkA9DhRp6KiHwA0dX8SR6s-dJJLL6IE3_cMpnt4M7Kic6iJ0C1yR8MIsblETp7gmf3xeblZEMAcSsDPQcsJ-NLjOgYlJ_2r50BWs2vWuuB2J8x7BlZLS1OW9AUIqeyAY-O2pGPbLW8MKII-JQE3AsDf2d_0Jc7ejoDQIwjn_Tm2VQ4gcX-KDFYvUmDpJIBocDV4RqL_ERM5PeeN6APaVme9ZHw_lTh84YDc7lkIlzssGfv6-ggHNARwXfj8oz1FpAALngyYwQ">
                            <div
                                class="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            </div>
                        </div>
        ...
        <section class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop" id="doctors">
            <div
                class="flex flex-col md:flex-row justify-between items-end mb-lg border-b border-outline-variant/30 pb-sm">
                <div>
                    <h2 class="font-headline-lg text-headline-lg text-primary mb-xs">Dokter Spesialis Kami</h2>
                    <p class="font-body-md text-body-md text-on-surface-variant">Tim medis profesional yang siap
                        memberikan perawatan terbaik.</p>
                </div>
                <a class="hidden md:flex font-label-md text-label-md text-secondary items-center gap-xs hover:underline mt-sm"
                    href="pages/spesialis.php">Lihat Semua <span
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-gutter">
                ...
                <div
                    ...
                    <div
                        ...
                        <img alt="<?= htmlspecialchars($doc['nama']) ?>"
                            class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                            src="<?= $fotoSrc ?>">
                    </div>
                    <h3 class="font-headline-md text-headline-md text-on-background mb-1">
                        <?= htmlspecialchars($doc['nama']) ?></h3>
                    <p class="font-label-sm text-label-sm text-secondary mb-2 uppercase tracking-wider">
                        <?= htmlspecialchars($doc['spesialisasi']) ?></p>
                    ...
                    <p class="font-body-sm text-body-sm text-on-surface-variant mb-6 leading-relaxed text-center">
                        <?= htmlspecialchars($doc['bio'] ?: 'Dokter spesialis di GlowCare Clinic.') ?></p>
                    <div class="flex flex-wrap gap-2 mt-auto justify-center">
                        <span
                            class="px-3 py-1 rounded-full bg-secondary-container text-on-secondary-container text-xs font-medium"><?= htmlspecialchars($doc['spesialisasi']) ?></span>
                    </div>
                </div>
                <?php endforeach; ?>
                <?php else: ?>
                ...
                <div
                    class="bg-surface-container-lowest rounded-2xl shadow-ambient text-center group p-md flex flex-col">
                    <div
                        class="w-32 h-32 mx-auto rounded-full overflow-hidden mb-md border-4 border-surface shadow-sm relative">
                        <img alt="Doctor"
                            class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                    ...
                    <p class="font-body-sm text-body-sm text-on-surface-variant mb-6 leading-relaxed text-center">
                        Spesialis bedah plastik dan rekonstruksi wajah.</p>
                </div>
                <div
                    class="bg-surface-container-lowest rounded-2xl shadow-ambient text-center group p-md flex flex-col">
                    <div
                    ...
                    <p class="font-label-sm text-label-sm text-secondary mb-4 uppercase tracking-wider">Aesthetic
                        Physician</p>
                    <p class="font-body-sm text-body-sm text-on-surface-variant mb-6 leading-relaxed text-center">
                        Spesialis perawatan estetika non-invasif.</p>
                </div>
                <div
                    class="bg-surface-container-lowest rounded-2xl shadow-ambient text-center group sm:hidden md:block p-md flex flex-col">
                    <div
                        class="w-32 h-32 mx-auto rounded-full overflow-hidden mb-md border-4 border-surface shadow-sm relative">
                        <img alt="Doctor"
                            class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                    ...
                    <p class="font-body-sm text-body-sm text-on-surface-variant mb-6 leading-relaxed text-center">Ahli
                        dermatologi klinis.</p>
                </div>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop py-xl" id="testimonials">
            <div class="text-center mb-lg">
                ...
                <p class="font-body-md text-body-md text-on-surface-variant max-w-2xl mx-auto">Pengalaman nyata dari
                    mereka yang telah mempercayakan perawatan kulitnya kepada GlowCare.</p>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-xl">
                ...
                <div class="space-y-md relative overflow-hidden">
                    <div class="flex gap-md overflow-x-auto snap-x snap-mandatory pb-4 hide-scrollbar">
                        <!-- Testimonial Card 1 -->
                        <div
                            class="bg-surface-container-lowest p-md rounded-2xl shadow-ambient relative min-w-full md:min-w-[80%] snap-center">
                            <span
                                class="material-symbols-outlined absolute top-4 right-4 text-primary-container opacity-50"
                                style="font-size: 48px;">format_quote</span>
                            <div class="flex items-center gap-sm mb-sm">
                                <div
                                    class="w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center font-headline-md text-primary">
                                    E</div>
                                <div>
                                    <div class="font-label-md text-label-md text-on-background">Elena R.</div>
                                    <div class="font-label-sm text-label-sm text-on-surface-variant">Pasien Brightening
                                    </div>
                                </div>
                            </div>
                            <p class="font-body-md text-body-md text-on-surface-variant italic relative z-10">
                                "Perawatan di GlowCare sangat luar biasa. Dokter Anisa sangat detail menjelaskan progres
                                perawatan. Flek hitam saya memudar signifikan dalam 2 bulan."
                            </p>
                        </div>
                        <!-- Testimonial Card 2 -->
                        <div
                            ...
                            <div class="flex items-center gap-sm mb-sm">
                                <div
                                    class="w-10 h-10 rounded-full bg-secondary-container flex items-center justify-center font-headline-md text-secondary">
                                    D</div>
                                <div>
                                    <div class="font-label-md text-label-md text-on-background">Dina K.</div>
                                    <div class="font-label-sm text-label-sm text-on-surface-variant">Pasien Acne Care
                                    </div>
                                </div>
                            </div>
                            <p class="font-body-md text-body-md text-on-surface-variant italic relative z-10">
                                "Setelah berjuang dengan jerawat bertahun-tahun, program Acne Care di sini benar-benar
                                menyelamatkan kulit saya. Sangat merekomendasikan!"
                            </p>
                        </div>
                    </div>
                ...
                <div class="bg-surface-container-low rounded-2xl p-md shadow-ambient">
                    ...
                    <div class="grid grid-cols-2 gap-sm">
                        <div class="rounded-xl overflow-hidden shadow-sm relative">
                            ...
                            <span
                                class="absolute bottom-2 left-2 bg-background/80 text-on-background px-2 py-0.5 text-xs rounded">Sebelum</span>
                        </div>
                        <div class="rounded-xl overflow-hidden shadow-sm relative">
                            <img alt="After Treatment" class="w-full h-32 object-cover" src="asset/img/after.png">
                            <span
                                class="absolute bottom-2 right-2 bg-primary/90 text-on-primary px-2 py-0.5 text-xs rounded">Sesudah</span>
                        </div>
                    </div>
                    <p class="text-center text-xs text-on-surface-variant mt-sm mt-4">*Hasil dapat bervariasi pada
                        setiap individu.</p>
                </div>
            </div>
        </section>
    ...
    <footer
        ...
        <div class="col-span-1 md:col-span-1 space-y-sm flex flex-col">
            ...
            <a class="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors"
                href="pages/treatment/treatment.php">Layanan</a>
            <a class="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors"
                href="pages/spesialis.php">Dokter</a>
            <a class="font-body-sm text-body-sm text-on-surface-variant hover:text-primary transition-colors"
                href="pages/kontak.php">Contact</a>
        </div>
        <!-- Map Placeholder -->
