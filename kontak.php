...
<div class="lg:col-span-5 space-y-12 h-full flex flex-col justify-between py-2"><div class="space-y-12">
    <div class="space-y-8">
        <div>
            ...
            <div class="flex items-start gap-6 group">
                <div class="p-4 bg-surface-container-low rounded-2xl text-primary group-hover:bg-primary group-hover:text-on-primary transition-all duration-300">
        ...
        <div>
            ...
            <div class="space-y-6">
                <a class="flex items-center gap-6 group cursor-pointer w-fit" href="tel:+1234567890">
                    <div class="p-4 bg-surface-container-low rounded-2xl text-primary group-hover:bg-primary group-hover:text-on-primary transition-all duration-300">
                        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">phone</span>
                    </div>
                    <span class="font-body-lg text-on-surface group-hover:text-primary transition-colors">+1 234 567 890</span>
                </a>
                <a class="flex items-center gap-6 group cursor-pointer w-fit" href="mailto:hello@glowcare.com">
                    <div class="p-4 bg-surface-container-low rounded-2xl text-primary group-hover:bg-primary group-hover:text-on-primary transition-all duration-300">
                        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">mail</span>
                    </div>
                    <span class="font-body-lg text-on-surface group-hover:text-primary transition-colors">hello@glowcare.com</span>
                </a>
            </div>
        </div>
        <div>
    ...
    <div class="pt-8 border-t border-surface-container-low">
        ...
        <div class="flex gap-6">
            <a class="w-14 h-14 rounded-2xl border border-outline-variant flex items-center justify-center text-on-surface-variant hover:border-primary hover:text-primary hover:bg-surface-container-low transition-all shadow-sm" href="#">
...
<a class="inline-flex items-center gap-3 bg-primary text-on-primary px-6 py-3 rounded-xl font-label-md hover:bg-surface-tint transition-all" href="#">
                        Get Directions
