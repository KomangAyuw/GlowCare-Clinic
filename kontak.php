...
<style>
        body { background-color: theme('colors.background'); color: theme('colors.on-background'); font-family: 'Inter', sans-serif; }
        .lux-input {
            width: 100%;
...
<!-- Active Item (Contact) -->
<a class="font-label-md text-label-md px-4 py-2 text-primary font-bold border-b-2 border-primary pb-1 hover:bg-primary-container/20 rounded-t-lg transition-all duration-300 ease-in-out" href="kontak.php">Contact</a>
</nav>
<!-- Actions -->
...
<p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">Experience bespoke clinical care. Our concierge team is ready to assist you in designing your personalized aesthetic journey.</p>
</div>
</section>
...
<div class="lg:col-span-5 space-y-12 h-full flex flex-col justify-between py-2"><div class="space-y-12">
    <div class="space-y-8">
        <div>
            <h3 class="font-display-lg text-label-md text-primary uppercase tracking-[0.2em] mb-8">Clinic Location</h3>
            <div class="flex items-start gap-6">
                ...
                <div class="pt-1">
                    ...
                    <p class="font-body-md text-on-surface-variant leading-relaxed">Mataram, Nusa Tenggara Barat,<br>Indonesia</p>
                </div>
            </div>
        </div>
        <div>
            <h3 class="font-display-lg text-label-md text-primary uppercase tracking-[0.2em] mb-8">Contact Info</h3>
            <div class="space-y-6">
                ...
                <a class="flex items-center gap-6 cursor-pointer w-fit" href="mailto:hello@glowcare.com">
                    <div class="p-4 bg-surface-container-low rounded-2xl text-primary">
        ...
        <div>
            <h3 class="font-display-lg text-label-md text-primary uppercase tracking-[0.2em] mb-8">Operating Hours</h3>
            <div class="flex items-start gap-6">
                <div class="p-4 bg-surface-container-low rounded-2xl text-primary">
                ...
                <div class="space-y-3 w-full max-w-[300px] pt-1">
                    <div class="flex justify-between items-center border-b border-surface-container-low pb-3">
    ...
    <div class="pt-8 border-t border-surface-container-low">
        <h3 class="font-display-lg text-label-md text-primary uppercase tracking-[0.2em] mb-8">Connect With Us</h3>
        <div class="flex gap-6">
            <a class="w-14 h-14 rounded-2xl border border-outline-variant flex items-center justify-center text-on-surface-variant hover:border-primary hover:text-primary hover:bg-surface-container-low transition-all shadow-sm" href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            ...
            <a class="w-14 h-14 rounded-2xl border border-outline-variant flex items-center justify-center text-on-surface-variant hover:border-primary hover:text-primary hover:bg-surface-container-low transition-all shadow-sm" href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg>
            </a>
        </div>
    </div>
</div></div>
...
<div class="ml-margin-mobile md:ml-margin-desktop bg-surface-container-lowest/95 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-primary/10 max-w-sm pointer-events-auto">
<div class="w-12 h-1 bg-primary mb-6"></div>
<h4 class="font-headline-md text-headline-md text-primary mb-4">Visit Our Clinic</h4>
<p class="font-body-md text-on-surface-variant mb-8 leading-relaxed">Located in the heart of Mataram, our clinic offers a sanctuary for clinical aesthetics with dedicated private parking for our patients.</p>
<a class="inline-flex items-center gap-3 bg-primary text-on-primary px-6 py-3 rounded-xl font-label-md hover:bg-surface-tint transition-all" href="https://maps.google.com/?q=Universitas+Mataram+Lombok+NTB+Indonesia" target="_blank" rel="noopener noreferrer">
                        Get Directions
...
<!-- Footer -->
<footer class="w-full bg-surface-container-low dark:bg-surface-container-lowest border-t border-outline-variant dark:border-outline">
<div class="w-full px-margin-desktop py-xl flex flex-col md:flex-row justify-between items-center gap-lg max-w-[1200px] mx-auto">
<!-- Brand Logo -->
<a href="index.php" class="font-headline-md text-headline-md text-primary dark:text-primary-fixed-dim">
                GlowCare
            </a>
<!-- Links -->
<ul class="flex flex-col md:flex-row flex-wrap gap-md items-center">
