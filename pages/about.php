...
<body
    class="bg-background text-on-background antialiased selection:bg-primary-container selection:text-on-primary-container font-body-md text-body-md pt-24">

    <!-- Header -->
    <header
        class="fixed w-full z-50 bg-surface/80 backdrop-blur-md shadow-sm transition-all duration-300 ease-in-out top-0">
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-gutter items-center">
                <div class="order-2 md:order-1 pr-0 md:pr-lg">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant mb-4">
                        Founded on the principle that true beauty is an expression of deep, holistic well-being,
                        GlowCare has redefined aesthetic medicine. We blend clinical precision with luxurious
                        tranquility to reveal your most radiant self.
                    </p>
                </div>
                <div class="order-1 md:order-2">
                    <div class="rounded-lg overflow-hidden h-[400px] md:h-[500px]">
                        <img src="../asset/img/detail_treatment.png" alt="GlowCare Treatment"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                <div class="md:col-span-2 bg-surface-container-lowest rounded-lg p-lg shadow-ambient">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant mb-6">
                        To empower individuals through personalized, cutting-edge aesthetic treatments that enhance
                        natural beauty and foster profound self-confidence.
                    </p>
                    <p class="font-body-md text-body-md text-on-surface-variant">
                        We envision a world where aesthetic care is a seamless integration of advanced medical science
                        and deeply restorative personal care, setting a new standard for luxury wellness.
                    </p>
                </div>
                <div
                    class="md:col-span-1 bg-primary-container rounded-lg p-lg flex flex-col items-center justify-center text-center shadow-ambient">
        ...
        <section class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop py-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                ...
                <div class="bg-surface-container-lowest p-md rounded-lg shadow-ambient">
                    <div
                        class="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container flex items-center justify-center mb-md">
                        <span class="material-symbols-outlined text-sm">psychology</span>
                    </div>
                    <h3 class="font-headline-md text-headline-md text-on-background mb-sm">Personalized Care</h3>
                    <p class="font-body-sm text-body-sm text-on-surface-variant">
                        We recognize that every face is unique. Our approach is entirely bespoke, tailored to your
                        specific anatomy and desires.
                    </p>
                </div>
                <!-- Value 2 -->
                <div class="bg-surface-container-lowest p-md rounded-lg shadow-ambient">
                    ...
                    <p class="font-body-sm text-body-sm text-on-surface-variant">
                        We continually invest in the most advanced, clinically proven technologies to ensure optimal
                ...
                <div class="bg-surface-container-lowest p-md rounded-lg shadow-ambient">
                    ...
                    <p class="font-body-sm text-body-sm text-on-surface-variant">
                        Honesty in consultation is our hallmark. We only recommend treatments that will genuinely
                        benefit you, prioritizing your long-term wellness.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop py-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                ...
                <div class="bg-surface-container-lowest rounded-lg overflow-hidden shadow-ambient">
                    <img src="../asset/img/doctor1.png" alt="Dr. Amanda Hayes"
                    ...
                    <div class="p-md text-center">
                        ...
                        <p class="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider mb-3">
                            Medical Director, Dermatologist</p>
                        <div class="flex justify-center text-primary-fixed-dim mb-4">
                            <span class="material-symbols-outlined"
                                style="font-variation-settings: 'FILL' 1; font-size: 16px;">star</span>
                            <span class="material-symbols-outlined"
                                style="font-variation-settings: 'FILL' 1; font-size: 16px;">star</span>
                            <span class="material-symbols-outlined"
                                style="font-variation-settings: 'FILL' 1; font-size: 16px;">star</span>
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant">
                            Specializing in holistic facial rejuvenation and advanced laser therapies, Dr. Hayes brings
                            over 15 years of clinical excellence to GlowCare.
                        </p>
                    </div>
                </div>
                <!-- Specialist 2 -->
                <div class="bg-surface-container-lowest rounded-lg overflow-hidden shadow-ambient">
                    <img src="../asset/img/doctor2.png" alt="Dr. Marcus Chen"
                        class="w-full h-64 object-cover object-top">
                    <div class="p-md text-center">
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant">
                            Known for his meticulous approach to dermal fillers and neuromodulators, Dr. Chen focuses on
                            restoring youthful contours naturally.
                        </p>
                    </div>
                </div>
                <!-- Specialist 3 -->
                <div class="bg-surface-container-lowest rounded-lg overflow-hidden shadow-ambient">
                    <img src="../asset/img/doctor3.png" alt="Dr. Sarah Jenkins"
                        class="w-full h-64 object-cover object-top">
                    <div class="p-md text-center">
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant">
                            Dr. Jenkins blends surgical expertise with minimally invasive techniques, offering a
                            comprehensive spectrum of transformative care.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <footer
        ...
        <div class="col-span-1 md:col-span-1 space-y-md">
            ...
            <div class="flex gap-sm">
                <a class="text-primary hover:text-on-primary-fixed-variant transition-colors"
