...
<body
    class="bg-surface text-on-surface font-body-md antialiased min-h-screen flex flex-col selection:bg-primary-container selection:text-on-primary-container">
    <!-- TopNavBar -->
    <header
        class="bg-surface/80 backdrop-blur-md dark:bg-surface-dim/80 fixed top-0 w-full z-50 shadow-sm dark:shadow-none transition-all duration-300">
        <div
    ...
    <main class="flex-grow pt-[100px] pb-xl">
        ...
        <section class="max-w-[1200px] mx-auto px-margin-mobile md:px-margin-desktop py-xl text-center">
            <span
                class="inline-block px-4 py-1 rounded-full bg-primary-container text-on-primary-container font-label-sm text-label-sm mb-6 tracking-widest uppercase">The
                GlowCare Team</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
                ...
                <article
                    ...
                    <div class="relative h-[350px] overflow-hidden group">
                        ...
                        <img alt="Portrait of <?= htmlspecialchars($d['nama']) ?>"
                    ...
                    <div class="p-8 flex flex-col flex-grow">
                        ...
                        <a href="<?= isset($_SESSION['user_id']) ? 'user/dashboarduser.php?page=daftar-konsul&dokter_id=' . $d['id'] : 'auth/Signin.php' ?>"
                            class="w-full py-3 px-6 border border-secondary text-secondary font-label-md text-label-md rounded-lg hover:bg-secondary hover:text-on-secondary transition-colors duration-300 flex items-center justify-center gap-2 group mt-auto">
                            Book Consultation
                            <span
        ...
        <section class="max-w-[1000px] mx-auto px-margin-mobile md:px-margin-desktop py-xl">
            <div class="bg-surface-container-low rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
                ...
                <h3 class="font-headline-md text-headline-md text-primary mb-6 relative z-10">Our Clinical Philosophy
                </h3>
                <p
                    class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed relative z-10 max-w-3xl mx-auto">
                    At GlowCare, we believe true aesthetic enhancement requires a delicate balance of medical rigor and
                    artistic vision. Our commitment is rooted in unparalleled patient safety, achieving consistently
                    natural-looking results, and designing personalized care plans that respect the unique anatomy and
