...
<body>
        ...
        <div class="sidebar-doctor">
            <div class="sidebar-doc-avatar">
                <img src="<?= $fotoUrl ?>" alt="<?= $namaDisplay ?>"
                    onclick="showPanel('profil', document.querySelector('[onclick*=profil]'))" style="cursor:pointer">
            </div>
    ...
    <div class="main">
        ...
        <div class="topbar" style="justify-content: flex-end;">
            <div class="topbar-right">
                <button class="notif-btn-text btn-outline"
                    style="font-size: 11px; padding: 6px 16px; position: relative; display: flex; align-items: center; gap: 8px; cursor: pointer;"
                    onclick="showPanel('notifikasi', this)">
                    Notifikasi
                    <?php if ($totalNotifCount > 0): ?>
                    <span class="notif-dot"
                        style="display: inline-block; width: 6px; height: 6px; background: #e0c097; border-radius: 50%;"></span>
                    <?php endif; ?>
                </button>
                <a class="logout-btn" href="#" onclick="showLogoutModal(); return false;"
                    style="width: auto !important; padding: 6px 16px;">
                    Keluar
                </a>
            </div>
        </div>
        ...
        <div class="alert alert-success alert-notification"
            style="margin:16px 28px 0; padding:12px 18px; background:#d4edda; border:1px solid #c3e6cb; border-radius:8px; color:#155724; font-size:13px; transition: opacity 0.5s ease;">
            <?= htmlspecialchars($_GET['success']) ?>
        </div>
        <?php elseif (!empty($_GET['error'])): ?>
        <div class="alert alert-error alert-notification"
            style="margin:16px 28px 0; padding:12px 18px; background:#f8d7da; border:1px solid #f5c6cb; border-radius:8px; color:#721c24; font-size:13px; transition: opacity 0.5s ease;">
        ...
        <div class="content">
            ...
            <div class="panel active" id="panel-overview">
                ...
                <div class="hero-banner" style="margin: -36px -40px 36px -40px;">
                    ...
                    <div class="hero-sub">Selamat datang kembali di GlowCare Clinic. Yuk, layani pasien dengan sepenuh
                        hati.</div>
                </div>
                ...
                <div class="two-col">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="card-action"
                                onclick="showPanel('jadwal', document.querySelector('[onclick*=jadwal]'))">Lihat semua
                                →</a>
                        </div>
                        <div class="schedule-list">
                            ...
                            <div class="schedule-item">
                                ...
                                <span class="badge <?= badgeClass($j['status']) ?>"
                        ...
                        <div class="card">
                            ...
                            <div style="padding:0 24px 24px">
                                ...
                                <div style="display:flex; align-items:center; gap:14px; margin-bottom:16px">
                                    ...
                                    <div>
                                        <div
                                            style="font-family:'Playfair Display',serif; font-size:16px; color:#2D3436">
                                ...
                                <div
                                    style="background:#F9F7F2; border-radius:8px; padding:14px; font-size:12px; color:#585552; line-height:1.7; font-weight:300">
                                    <strong
                                        style="color:#2D3436; font-size:11px; letter-spacing:1px; text-transform:uppercase">Keluhan:</strong><br>
                                ...
                                <?php else: ?>
                                <div style="padding:8px 0; color:#7a7571; font-size:13px;">Tidak ada pasien berikutnya.
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div style="padding:0 24px 20px; display:flex; flex-direction:column; gap:14px">
                                ...
                                <div style="display:flex; justify-content:space-between; align-items:center">
                                    ...
                                    <span
                                        style="font-size:14px; color:#2D3436; font-weight:500"><?= (int)$statBulan['facelift'] ?></span>
                                </div>
                                <div style="display:flex; justify-content:space-between; align-items:center">
                                    <span style="font-size:12px; color:#585552">Rhinoplasty</span>
                                    <span
                                        style="font-size:14px; color:#2D3436; font-weight:500"><?= (int)$statBulan['rhinoplasty'] ?></span>
                                </div>
                                <div style="display:flex; justify-content:space-between; align-items:center">
                                    <span style="font-size:12px; color:#585552">Blepharoplasty</span>
                                    <span
                                        style="font-size:14px; color:#2D3436; font-weight:500"><?= (int)$statBulan['blepharoplasty'] ?></span>
                                </div>
                                <div style="height:1px; background:#F9F7F2"></div>
                                <div style="display:flex; justify-content:space-between; align-items:center">
            ...
            <div class="panel" id="panel-jadwal">
                <div class="page-header">
                    ...
                    <div
                        style="font-size:11px; color:#7a7571; padding:8px 14px; background:#fff; border:1px solid #d1c4b8; border-radius:50px">
                ...
                <div class="card">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <?php if (empty($jadwalHariIni)): ?>
                            <tr>
                                <td colspan="7" style="text-align:center; color:#7a7571; padding:24px">Tidak ada jadwal
                                    hari ini.</td>
                            </tr>
                            <?php else: ?>
                            <?php foreach ($jadwalHariIni as $j): ?>
                            <tr>
                                <td class="td-jam"
                                    style="<?= $j['status'] === 'Berlangsung' ? 'color:#735a39; font-weight:500' : '' ?>">
                                ...
                                <td><span
                                        class="badge <?= badgeClass($j['status']) ?>"><?= htmlspecialchars($j['status']) ?></span>
                                </td>
                                <td>
                                    ...
                                    <button class="act-btn"
                                        style="border: 1px solid #735a39; padding: 4px 10px; color: #735a39; background: #fff;"
                ...
                <div class="card">
                    <table class="data-table" id="tabel-pasien">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" style="text-align:center; color:#7a7571; padding:24px">Belum ada data
                                    pasien.</td>
                            </tr>
                            <?php else: ?>
                            ...
                            <tr data-nama="<?= htmlspecialchars(strtolower($p['nama'])) ?>"
                                ...
                                <td>
                                    <div style="font-size:12px"><?= htmlspecialchars($p['no_telp'] ?? '-') ?></div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button class="act-btn"
                                        style="border: 1px solid #735a39; padding: 4px 10px; color: #735a39;"
                                        title="Rekam medis"
                        ...
                        <div class="pasien-detail-header">
                            ...
                            <div style="margin-left:auto; display:flex; gap:10px; align-items:center">
                                ...
                                <button class="btn-outline" style="font-size:10px; padding:7px 16px"
                                    id="btn-rm-dari-detail" onclick="openModal('modal-rm-baru')">+ Rekam Medis</button>
                            </div>
                        </div>
            ...
            <div class="panel" id="panel-rekam-medis">
                ...
                <?php if (!empty($_GET['success'])): ?>
                <div class="alert alert-success alert-notification"
                    style="margin-bottom:20px; padding:12px 18px; background:#d4edda; border:1px solid #c3e6cb; border-radius:8px; color:#155724; font-size:13px; transition: opacity 0.5s ease;">
                    <?= htmlspecialchars($_GET['success']) ?>
                </div>
                <?php elseif (!empty($_GET['error'])): ?>
                <div class="alert alert-error alert-notification"
                    style="margin-bottom:20px; padding:12px 18px; background:#f8d7da; border:1px solid #f5c6cb; border-radius:8px; color:#721c24; font-size:13px; transition: opacity 0.5s ease;">
                    <?= htmlspecialchars($_GET['error']) ?>
                </div>
                <?php endif; ?>
                <?php endif; ?>
                ...
                <div class="filter-bar">
                    <input class="filter-input" type="text" id="cari-rm" placeholder="Cari nama pasien..."
                        oninput="filterRM()">
                ...
                <div class="rm-content active" id="tab-rm-list">
                    ...
                    <div class="rm-card" data-nama="<?= htmlspecialchars(strtolower($rm['nama_pasien'])) ?>"
                        data-treatment="<?= htmlspecialchars($rm['treatment'] ?? '') ?>"
                        data-bulan="<?= date('Y-m', strtotime($rm['tanggal'])) ?>">
                        <div class="rm-card-header">
                            <div>
                                <div class="rm-card-title">
                                    <?= htmlspecialchars($rm['nama_pasien']) ?> ·
                                    <?= htmlspecialchars($rm['treatment'] ?? '-') ?>
                                </div>
                            ...
                            <div style="text-align:right">
                                ...
                                <span class="badge <?= badgeClass($rm['status']) ?>"
                        ...
                        <div class="rm-body">
                            ...
                            <strong
                                style="font-size:11px; letter-spacing:1px; text-transform:uppercase; color:#2D3436">Anamnesis:</strong><br>
                            <?= nl2br(htmlspecialchars($rm['anamnesis'])) ?>
                            <br><br>
                            <?php endif; ?>
                            <?php if (!empty($rm['pemeriksaan'])): ?>
                            <strong
                                style="font-size:11px; letter-spacing:1px; text-transform:uppercase; color:#2D3436">Hasil
                                Pemeriksaan & Tindakan:</strong><br>
                        ...
                        <div style="display:flex; gap:8px; margin-top:16px">
                            ...
                            <button class="btn-outline"
                                style="font-size:10px; padding:7px 16px; color:#c0392b; border-color:#e8b5ac;"
            ...
            <div class="panel" id="panel-notifikasi">
                ...
                <div class="card" style="padding: 24px;">
                    ...
                    <div
                        style="padding: 16px; background:#fbf8f3; border:1px solid #efebe4; border-radius:10px; margin-bottom:12px; display:flex; gap:15px; align-items:flex-start;">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            style="color:#735a39; flex-shrink: 0; margin-top: 2px;">
                            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0"></path>
                        </svg>
                        <div style="flex: 1;">
                            <div
                                style="font-weight:500; color:#4a321f; font-family: 'Playfair Display', serif; font-size: 15px;">
                                <?= htmlspecialchars($p['judul']) ?></div>
                            <div style="font-size:12px; color:#7d6756; margin-top:4px; line-height: 1.5;">
                                <?= nl2br(htmlspecialchars($p['konten'])) ?></div>
                            <div style="font-size:10px; color:#a89a8a; margin-top:8px;">
                                <?= date('d M Y, H:i', strtotime($p['created_at'])) ?> WIB</div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div
                        style="padding: 16px; background:#e8f9f1; border:1px solid #a7f3d0; border-radius:10px; margin-bottom:12px; display:flex; gap:15px; align-items:center;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size:12px; color:#735a39; margin-top:3px;">Pasien
                                <strong><?= htmlspecialchars($appt['nama_pasien']) ?></strong> mengajukan janji temu
                                untuk <?= htmlspecialchars($appt['nama_treatment'] ?: 'Konsultasi Umum') ?> pada
                                <?= date('d M Y', strtotime($appt['tanggal'])) ?> pukul
                                <?= substr($appt['jam'], 0, 5) ?> WIB.</div>
                        </div>
                        <button class="btn-primary btn-sm"
                            onclick="showPanel('jadwal', document.querySelector('[onclick*=jadwal]'))">Lihat
                            Jadwal</button>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div
                        style="padding: 16px; background:#f8efe8; border:1px solid #f1dec9; border-radius:10px; margin-bottom:12px; display:flex; gap:15px; align-items:center;">
                        <span style="font-size:24px; font-weight:bold; color:#735a39;">💬</span>
                        <div style="flex: 1;">
                            <div style="font-weight:500; color:#4a321f;">Pesan Chat Baru</div>
                            <div style="font-size:12px; color:#7d6756; margin-top:3px;">Ada pesan baru belum dibaca dari
                                pasien <strong><?= htmlspecialchars($chat['nama_pasien']) ?></strong>.</div>
                        </div>
                        <a class="btn-primary btn-sm" href="chat.php?appt_id=<?= (int)$chat['consultation_id'] ?>"
                            style="text-decoration:none;">Balas Chat</a>
                    </div>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </div>
            ...
            <div class="panel" id="panel-profil">
                ...
                <div class="profil-hero">
                    <div class="profil-avatar-wrap">
                        <div class="profil-avatar">
                            <img src="<?= $fotoUrl ?>" alt="<?= $namaDisplay ?>"
                                onclick="showPanel('profil', document.querySelector('[onclick*=profil]'))"
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:22px">
                    ...
                    <div class="card">
                        ...
                        <div style="padding:0 24px 24px">
                            <form method="POST" action="../../backend/dokter/update_profil.php">
                                ...
                                <button type="submit" class="btn-primary" style="margin-top:8px">Simpan Data
                                    Pribadi</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Informasi Profesional</div>
                        </div>
                        <div style="padding:0 24px 24px">
                            <form method="POST" action="../../backend/dokter/update_profil.php">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-input" type="number" name="tahun_pengalaman"
                                ...
                                <button type="submit" class="btn-primary" style="margin-top:8px">Simpan Info
                                    Profesional</button>
                            </form>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="../../backend/dokter/ganti_password.php">
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-input" type="password" name="konfirmasi"
                                            placeholder="••••••••">
                                    </div>
                                </div>
            ...
            <div class="panel" id="panel-ulasan">
                ...
                <div class="card" style="text-align:center; padding:48px 24px;">
                    ...
                    <div
                        style="font-family:'Playfair Display',serif; font-size:18px; color:#4a321f; margin-bottom:6px;">
                        Belum Ada Ulasan</div>
                    <div style="font-size:13px; color:#7d6756; font-weight:300;">Ulasan akan muncul setelah pasien
                        memberikan rating setelah kunjungan selesai.</div>
                </div>
                <?php else: ?>
                ...
                <div class="card" style="padding:20px 24px; margin-bottom:12px;">
                    <div
                        ...
                        <div style="display:flex; align-items:center; gap:12px;">
                            <div
                                style="width:40px; height:40px; background:#f5e7dc; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:600; color:#735a39; font-size:15px;">
                                <?= strtoupper(mb_substr($ul['nama_pasien'], 0, 1)) ?>
                            </div>
                            <div>
                                <div style="font-size:14px; font-weight:500; color:#4a321f;">
                                    <?= htmlspecialchars($ul['nama_pasien']) ?></div>
                                <div style="font-size:11px; color:#a89a8a;">
                                    <?= date('d M Y, H:i', strtotime($ul['created_at'])) ?> WIB</div>
                            </div>
                        </div>
            ...
            <form method="POST" action="../../backend/dokter/simpan_rekam_medis.php">
                <div class="form-row">
                    ...
                    <div class="form-group full">
                        ...
                        <textarea class="form-textarea" name="anamnesis"
                            placeholder="Tulis keluhan dan riwayat penyakit pasien..."></textarea>
                    </div>
                    <div class="form-group full">
                        <label class="form-label">Hasil Pemeriksaan &amp; Tindakan</label>
                        <textarea class="form-textarea" name="pemeriksaan"
                            placeholder="Hasil pemeriksaan fisik, tindakan yang dilakukan, dosis obat..."></textarea>
                    </div>
                    <div class="form-group full">
                        <label class="form-label">Rencana Tindak Lanjut</label>
                        <textarea class="form-textarea" name="tindak_lanjut"
                            placeholder="Follow-up, obat yang diberikan, jadwal kunjungan berikutnya..."></textarea>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-overlay" id="modal-hapus-rm" onclick="closeModalOutside(event,'modal-hapus-rm')">
        <div class="modal" style="max-width:420px; text-align:center;">
            <div
                style="width:56px;height:56px;background:#fce4df;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;font-size:24px;">
                🗑️</div>
            ...
            <form method="POST" action="../../backend/dokter/hapus_rekam_medis.php">
                ...
                <div class="modal-footer" style="justify-content:center; gap:12px; margin-top:24px;">
                    ...
                    <button type="submit"
                        style="background:#e05050; color:#fff; border:none; padding:10px 24px; border-radius:50px; font-size:11px; letter-spacing:1.5px; text-transform:uppercase; font-family:'DM Sans',sans-serif; cursor:pointer;">Ya,
                        Hapus</button>
                </div>
            </form>
        </div>
    ...
    <div id="logout-modal"
        ...
        <div
            ...
            <p style="font-size:13px;color:#64748b;margin-bottom:28px;line-height:1.6">Sesi Anda sebagai
                <strong>Dokter</strong> akan diakhiri. Anda perlu login kembali untuk mengakses portal.</p>
        ...
        fetch('../../backend/notifikasi/notif_count.php')
            ...
            .then(data => {
                ...
                if (data.count > 0) {
                    ...
                    dot.style.cssText =
                        'display: inline-block; width: 6px; height: 6px; background: #735a39; border-radius: 50%;';
                    btn.appendChild(dot);
                }
