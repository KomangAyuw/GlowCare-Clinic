...
<body class="bg-surface text-on-surface antialiased min-h-screen flex selection:bg-primary/20 selection:text-primary">
    ...
    <div class="hidden lg:block lg:w-1/2 relative bg-surface-container-high">
        <div class="absolute inset-0 bg-cover bg-center"
            style="background-image: url(&quot;../../asset/img/regis.png&quot;);"></div>
        <!-- Optional ambient overlay to ensure image doesn't clash with pure clinical feel -->
    </div>
    <!-- Right Screen: Form Canvas -->
    <div
        class="w-full lg:w-1/2 flex flex-col items-center justify-center px-margin-mobile sm:px-12 lg:px-margin-desktop py-12 relative z-10 bg-surface min-h-screen overflow-y-auto">
        <div class="max-w-md w-full my-auto">
            <!-- Header Section -->
            <div class="mb-8">
                <!-- Brand Anchor -->
                <div class="flex items-center gap-2 mb-12"><span class="material-symbols-outlined text-primary text-3xl"
                        style="font-variation-settings: &quot;FILL&quot; 1;">spa</span><span
                        class="font-headline-md text-headline-md text-primary tracking-tight">GlowCare</span></div>
            ...
            <div id="error-container"
                class="<?php echo $error ? '' : 'hidden'; ?> bg-error-container border border-error text-on-error-container px-4 py-3 rounded-lg mb-6 font-body-sm flex items-center gap-2">
            ...
            <form action="../../backend/auth/Regist.php" class="space-y-6" method="POST" id="signup-form" novalidate>
                <div class="space-y-sm">
                    <div>
                        ...
                        <input
                            class="block w-full px-4 py-3 rounded-lg border border-outline-variant bg-surface-container-lowest text-on-surface font-body-md text-body-md placeholder:text-on-surface-variant/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all duration-200"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input autocomplete="new-password"
                                class="block w-full pl-4 pr-12 py-3 rounded-lg border border-outline-variant bg-surface-container-lowest text-on-surface font-body-md text-body-md placeholder:text-on-surface-variant/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all duration-200"
                                id="password" name="password" required="" type="password" maxlength="8">
                            <button type="button"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-on-surface-variant/70 hover:text-primary transition-colors toggle-password"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input autocomplete="new-password"
                                class="block w-full pl-4 pr-12 py-3 rounded-lg border border-outline-variant bg-surface-container-lowest text-on-surface font-body-md text-body-md placeholder:text-on-surface-variant/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all duration-200"
                                id="konfirmasi" name="konfirmasi" required="" type="password" maxlength="8">
                            <button type="button"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-on-surface-variant/70 hover:text-primary transition-colors toggle-password"
                ...
                <div>
                    <button
                        class="w-full flex justify-center py-4 px-4 border border-transparent rounded-lg shadow-sm font-label-md text-label-md text-on-primary bg-primary hover:bg-surface-tint focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-surface transform active:scale-[0.98] transition-all duration-200"
                        type="submit">
                        Register Now
                    </button>
                </div>
            ...
            <div class="text-center font-body-sm text-body-sm text-on-surface-variant pt-md">
                ...
                <a class="font-medium text-primary hover:text-surface-tint underline decoration-primary/50 hover:decoration-primary underline-offset-4 transition-all"
                    href="Signin.php">
                    Log In
                </a>
            </div>
        ...
        <div class="absolute bottom-6 left-0 right-0 text-center lg:text-left lg:pl-margin-desktop w-full">
            <a href="../../index.php"
                class="inline-flex items-center gap-2 font-label-md text-primary hover:text-on-primary-fixed-variant transition-colors">
